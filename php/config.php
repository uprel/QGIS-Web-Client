...
define('DEFAULT_SEARCH_LAYERS', 'Občine,Lokacije,Katastrske občine,Parcele,Stavbe');
...
define('WMS_ONLINE_RESOURCE', 'http://localhost:12/qgis/qgis_mapserv.fcgi?');
